...
class ConstructionItemListActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.setItems(sampleConstructionItems())
    }

    private fun sampleConstructionItems(): List<ConstructionItem> {
        return listOf(
            ConstructionItem(
                1,
                "Metal & Parts",
                "High-quality steel beams",
                100,
                R.drawable.compasslogo.toString()
            ),
            ConstructionItem(
                2,
                "Hammers & Drones",
                "Durable hammers and construction drones",
                50,
                R.drawable.team.toString()
            ),
            ConstructionItem(
                3,
                "Ladders & Scaffolding",
                "Sturdy ladders and safe scaffolding",
                20,
                R.drawable.iconsite.toString()
            ),
            ConstructionItem(
                4,
                "Power Tools",
                "Variety of power tools for construction",
                15,
                R.drawable.iconsite.toString()
            ),
            ConstructionItem(
                5,
                "BIM Software",
                "Enables a realistic model of a building",
                10,
                R.drawable.iconsite.toString()
            ),
            ConstructionItem(
            ...
            ConstructionItem(
                10,
                "Lumber",
                "Various types of wood for construction",
                300,
                R.drawable.team.toString()
            ),
            ConstructionItem(
                11,
                "Paint",
                "Paint for walls, floors, and ceilings",
                200,
                R.drawable.team.toString()
            )
        )
